...
var InstitutionsController = /** @class */ (function () {
    ...
    InstitutionsController.prototype.getByName = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var institutionByName, err_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                    ...
                    case 1:
                        institutionByName = _a.sent();
                        console.log(institutionByName);
                        return [2 /*return*/, res.send(institutionByName)];
                    case 2:
                        err_2 = _a.sent();
