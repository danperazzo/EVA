...
# NOVOS CENÁRIOS
   ################################# GUI Scenario #################################
    ...
    Scenario: seleção bem sucedida das ocorrências em um intervalo de datas
        Given o sistema possui "4" ocorrências armazenadas entre as datas
            "2021-04-24" e "2021-05-30"
        When o usuário solicita as ocorrências entre as datas
            "2021-04-24" e "2021-05-30"
        Then o sistema retorna uma lista com "4" ocorrências